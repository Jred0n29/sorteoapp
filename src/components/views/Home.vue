<template>
    ...
    Money..!
                ...
                <div class="mx-auto p-4">
                    <a href="https://chat.whatsapp.com/LCZGUO9ER6tL7ZcjspVQx4" class="box-border relative z-30 inline-flex items-center justify-center w-auto px-8 py-3 overflow-hidden font-bold text-white transition-all duration-500 bg-red-500 rounded-md cursor-pointer group ring-offset-2 ring-1 ring-red-300 ring-offset-red-200 ease focus:outline-none transform animate-pulseUpDown">
