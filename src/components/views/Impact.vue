<template>
    ...
    <div
      class="flex flex-col justify-center items-center bg-[#FFF6F3]  shadow-xl ring-gray-900/5 px-4 h-[126px] w-[70%] md:w-[281px] md:h-[192px] rounded-lg justify-self-center">
      <div class="flex flex-row justify-center items-center">
        ...
        <p class="font-bold text-3xl sm:text-4xl lg:text-5xl leading-9 text-primary ml-2 ">73+</p>
      </div>
      <p class="font-medium text-base sm:text-lg leading-6 mt-3 md:mt-6 text-center ">Ganadores</p>
    </div>
