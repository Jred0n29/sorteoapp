<template>
    <section class="flex flex-col mt-20">
      <p class="flex justify-center w-full gap-2 pt-4 font-extrabold text-2xl md:text-3xl dark:text-white">
            <span class="text-primary-black dark:text-gray-300">Impacto</span>
    ...
    class="mt-10 grid grid-cols-1 lg:grid-cols-3 gap-y-5 lg:gap-y-0 gap-x-5 place-items-center w-full mx-auto max-w-7xl px-5">
    <div
      class="flex flex-col justify-center items-center bg-[#FFF6F3] dark:dark:bg-gray-900 shadow-xl ring-gray-900/5 px-4 h-[126px] w-[70%] md:w-[281px] md:h-[192px] rounded-lg justify-self-center">
      <div class="flex flex-row justify-center items-center">
        ...
        <p class="font-bold text-3xl sm:text-4xl lg:text-5xl leading-9 text-primary ml-2 dark:text-white">73+</p>
      </div>
      <p class="font-medium text-base sm:text-lg leading-6 mt-3 md:mt-6 text-center dark:text-white">Ganadores</p>
    </div>
    ...
    <div
      ...
      <div class="flex flex-row justify-center items-center">
        ...
        <p class="font-bold text-3xl sm:text-4xl lg:text-5xl leading-9 text-primary ml-2 ">523+</p>
      </div>
    ...
    <div
      ...
      <div class="flex flex-row justify-center items-center">
        ...
        <p class="font-bold text-3xl sm:text-4xl lg:text-5xl leading-9 text-primary ml-2">1.5+</p>
      </div>
      <p class="font-medium text-base sm:text-lg leading-6 mt-3 md:mt-6 text-center">Años de Experiencia</p>
    </div>
  </div>
</section>
</template>